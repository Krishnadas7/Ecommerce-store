...
const loadHomepage = async (req, res) => {
	try {
		...
		const sales = await Order.countDocuments({ 'products.orderStatus': 'Delivered' })
		const codCount = await Order.countDocuments({ 'products.orderStatus': 'Delivered', paymentMethod: 'COD' });
		const onlinePaymentCount = await Order.countDocuments({ 'products.orderStatus': 'Delivered', paymentMethod: 'online' });
		const walletCount = await Order.countDocuments({ 'products.orderStatus': 'Delivered', paymentMethod: 'wallet' });
